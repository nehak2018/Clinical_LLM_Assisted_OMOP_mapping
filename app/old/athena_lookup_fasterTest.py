# FAST Athena ICD -> OMOP lookup
# Major speedups:
# 1. Load Athena once (cache)
# 2. Pre-filter only ICD rows
# 3. Pre-index with dictionaries
# 4. O(1) lookup instead of repeated dataframe scans
# 5. No per-code dataframe filtering
...
if __name__ == "__main__":
    test_icds = ["I10", "E11.9", "I21.0", "J45.909"]
    output = lookup_icd_to_omop(test_icds)
